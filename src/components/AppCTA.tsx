...
const AppCTA = () => {
    return (
        <section className="py-24 bg-slate-950 overflow-hidden relative border-y border-slate-900">
            ...
            <div className="container mx-auto px-4 md:px-6 relative z-10">
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="relative hidden lg:block">
                        ...
                        <div className="mx-auto w-[300px] h-[600px] bg-slate-950 rounded-[3rem] border-8 border-slate-900 shadow-2xl relative overflow-hidden ring-1 ring-slate-800">
                            <div className="absolute top-0 w-full h-full bg-slate-900 flex flex-col items-center justify-center">
                                ...
                                <p className="text-slate-500 font-bold">App Interface</p>
                            </div>
                        </div>
                    </div>
                </div>
