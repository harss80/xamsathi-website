                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {faculty.map((tutor, idx) => (
                        <motion.div
                            ...
                            whileHover={{ y: -5 }}
                            className="bg-slate-50 rounded-xl overflow-hidden border border-slate-200 shadow-sm hover:shadow-xl hover:border-slate-300 transition-all text-center group"
                        >
                            ...
                            <div className="p-6">
                                ...
                                <div className="text-sm text-slate-600 mb-1">{tutor.education}</div>
                                <div className="text-sm text-slate-600">{tutor.exp}</div>
                            </div>
                        </motion.div>
                    ))}
                </div>
