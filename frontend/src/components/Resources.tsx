                    ...
                    {resources.map((res, i) => (
                        <Link href={res.link} key={i} className="block group">
                            <motion.div
                                ...
                                className={`h-full p-6 rounded-2xl bg-slate-50 border border-slate-200 transition-all ${res.border} hover:shadow-2xl hover:shadow-blue-900/20`}
                            >
                                ...
                                <h3 className="text-xl font-bold text-slate-900 mb-3 group-hover:text-blue-400 transition-colors">
                                    {res.title}
                                </h3>
                                <p className="text-slate-600 text-sm leading-relaxed mb-6">
                                    {res.description}
                                </p>
                                <div className="mt-auto flex items-center gap-2 text-sm font-bold text-slate-700 group-hover:text-slate-900 transition-colors">
