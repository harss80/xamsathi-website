...
export default function BANKINGEXAMSCategory() {
  const exams = [
    {
        id: 'sbi-po',
        title: 'SBI PO',
        desc: 'Pre & Mains Tests',
        tests: 150,
        users: '1.2 Lakh',
        tag: 'Popular',
        link: '/banking-exams/sbi-po'
    },
    {
        id: 'ibps-po',
        title: 'IBPS PO',
      ...
      <div className="pt-28 pb-16 bg-gradient-to-b from-slate-900 to-slate-950 border-b border-slate-800">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-black text-white mb-6">Master <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-emerald-400">Banking & Insurance</span></h1>
            <p className="text-lg text-slate-400 mb-8 leading-relaxed">
              Comprehensive test series for IBPS, SBI, RBI and other banking exams.
            </p>
      ...
      <div className="py-16">
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {exams.map((exam) => (
              <Link href={exam.link} key={exam.id} className="group flex flex-col bg-slate-900 border border-slate-800 rounded-2xl p-6 hover:border-slate-700 hover:bg-slate-800/30 transition-all duration-300 relative overflow-hidden">
                {exam.tag && (
