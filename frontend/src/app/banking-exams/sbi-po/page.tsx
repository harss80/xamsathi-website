  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200">
      <div className="max-w-5xl mx-auto px-4 py-12">
        <h1 className="text-3xl md:text-5xl font-black text-white">SBI PO</h1>
        <p className="text-slate-400 mt-4">Full mock drills to build speed, accuracy and confidence.</p>
