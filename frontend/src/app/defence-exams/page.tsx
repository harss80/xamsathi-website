    ...
    <div className="min-h-screen bg-slate-950 text-slate-200">
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h1 className="text-3xl md:text-5xl font-black text-white">Defence Exams</h1>
        </div>

        <p className="text-slate-400 max-w-3xl">
          NDA and other defence exams practice sets with strict timing and clear solutions.
        </p>

        <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-6">
          <Link href="/defence-exams/nda" className="p-6 rounded-3xl bg-slate-900 border border-slate-800 hover:border-indigo-500/50 transition-all">
            <div className="text-xl font-black text-white">NDA</div>
            <div className="text-sm text-slate-400 mt-2">Mock tests & practice</div>
          </Link>
        </div>
