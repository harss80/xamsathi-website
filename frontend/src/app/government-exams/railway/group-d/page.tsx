...
const testBreakdown = [
  {
    id: "full-tests",
    title: "RRB Group D Full Mock Tests",
    desc: "Strictly based on the latest Railway pattern. Includes negative marking (1/3rd).",
    testCount: 20,
    freeCount: 1,
    tests: [
      { name: "RRB Group D Full Mock Test 1", q: 100, m: 100, time: "90 Mins", isFree: true },
      { name: "RRB Group D Full Mock Test 2", q: 100, m: 100, time: "90 Mins", isFree: false },
      { name: "RRB Group D Full Mock Test 3", q: 100, m: 100, time: "90 Mins", isFree: false },
      { name: "RRB Group D Full Mock Test 4", q: 100, m: 100, time: "90 Mins", isFree: false },
      { name: "RRB Group D Full Mock Test 5", q: 100, m: 100, time: "90 Mins", isFree: false },
    ]
  },
  {
    id: "pyq-tests",
    title: "RRB Group D Previous Year Papers",
    desc: "Official papers from RRB Group D previous exams, set as timed mocks.",
    testCount: 15,
    freeCount: 1,
    tests: [
      { name: "RRB Group D (17th Aug 2022 - Shift 1)", q: 100, m: 100, time: "90 Mins", isFree: true },
      { name: "RRB Group D (17th Aug 2022 - Shift 2)", q: 100, m: 100, time: "90 Mins", isFree: false },
      { name: "RRB Group D (18th Aug 2022 - Shift 1)", q: 100, m: 100, time: "90 Mins", isFree: false },
    ]
  },
  {
    id: "science-chapter",
    title: "Chapter Tests - General Science",
    desc: "Topic-wise tests to strengthen your science foundation (Physics, Chemistry, Life Sciences).",
    testCount: 15,
    freeCount: 1,
    tests: [
      { name: "Physics: Motion and Force", q: 25, m: 25, time: "20 Mins", isFree: true },
      { name: "Chemistry: Periodic Table", q: 25, m: 25, time: "20 Mins", isFree: false },
      { name: "Life Sciences: Human Body Systems", q: 25, m: 25, time: "20 Mins", isFree: false },
    ]
  },
  {
    id: "math-reasoning",
    title: "Sectional Tests - Maths & Reasoning",
    desc: "Topic-wise reasoning & mathematics tests to improve speed and accuracy.",
    testCount: 15,
    freeCount: 1,
    tests: [
      { name: "Mathematics: Number System", q: 25, m: 25, time: "20 Mins", isFree: true },
      { name: "Reasoning: Coding Decoding", q: 30, m: 30, time: "25 Mins", isFree: false },
    ]
  }
];

const faqs = [
  { q: "Is this test series bilingual?", a: "Yes, all tests in the RRB Group D Mock Test Series are available in both English and Hindi. You can switch the language anytime during the test." },
  { q: "What is the validity of the plans?", a: "The Pro plan comes with 12 Months validity, All-India Rank, and detailed analytics. We also offer a 6 Months pass for focused preparation." },
  { q: "Are the questions based on the latest Railway pattern?", a: "Absolutely. All mock tests and sectional tests are updated strictly according to the latest RRB pattern." },
    ...
    <div className="min-h-screen bg-slate-950 text-slate-200 font-sans selection:bg-blue-500/30">
      ...
      <main className="container mx-auto px-4 md:px-6 pt-24 pb-20">
        ...
        <div className="flex items-center gap-2 text-sm text-slate-400 mb-6 font-medium">
          ...
          <span>›</span>
          <span className="text-white font-bold">RRB Group D</span>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-8 space-y-10">
            ...
            <div className="bg-slate-900 rounded-3xl p-8 border border-slate-800 shadow-xl relative overflow-hidden group">
              ...
              <div className="relative z-10">
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-white mb-4 tracking-tight leading-tight">
                  RRB Group D Mock Test Series 2026
                </h1>

                <p className="text-lg text-slate-400 mb-6 font-medium leading-relaxed max-w-2xl">
                  Boost your RRB Group D preparation with India's most trusted mock tests strictly based on the latest Railway exam pattern. Get detailed solutions, All India Ranks, and deep analytics.
                </p>

                <div className="flex flex-wrap items-center gap-6 mb-8 text-sm">
                  <div className="flex items-center gap-2 font-bold text-slate-200">
                    <Star className="w-5 h-5 text-amber-400 fill-amber-400" />
                    4.7 <span className="text-slate-500 font-medium">(11,400+ Ratings)</span>
                  </div>
                  <div className="flex items-center gap-2 font-bold text-slate-200">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                  <div className="flex flex-col items-center justify-center p-4 bg-slate-950/50 rounded-2xl border border-slate-800/50 text-center hover:border-slate-700 transition-colors">
                    ...
                    <span className="font-extrabold text-2xl text-white">65+</span>
                  ...
                  <div className="flex flex-col items-center justify-center p-4 bg-slate-950/50 rounded-2xl border border-slate-800/50 text-center hover:border-slate-700 transition-colors">
                    ...
                    <span className="font-extrabold text-2xl text-white">4+</span>
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4">
                  <Link href="/dashboard/test-series/railway-group-d" className="w-full sm:w-auto px-8 py-4 bg-blue-600 hover:bg-blue-500 text-white font-black rounded-xl transition-all flex items-center justify-center gap-2 text-lg shadow-lg shadow-blue-500/20 active:scale-95">
                    <Play className="w-5 h-5 fill-white" /> Start Free Demo
                  </Link>
                  <Link href="/government-exams/railway/group-d/schedule" className="w-full sm:w-auto px-8 py-4 bg-slate-950 border border-slate-700 hover:border-slate-500 hover:text-white text-slate-300 font-bold rounded-xl transition-all flex items-center justify-center gap-2 text-lg active:scale-95 shadow-sm">
            ...
            <div className="bg-slate-900 rounded-3xl border border-slate-800 shadow-xl overflow-hidden" id="test-syllabus">
              <div className="p-6 md:p-8 border-b border-slate-800 bg-slate-900/50 relative overflow-hidden">
                ...
                <p className="text-slate-400 mt-2 font-medium relative z-10">Explore everything included in the RRB Group D Test Series package.</p>
              </div>
                          ...
                          {category.tests.map((test, idx) => (
                            <div key={idx} className="flex flex-col lg:flex-row lg:items-center justify-between p-4 md:p-5 bg-slate-900 border border-slate-800 rounded-2xl hover:border-blue-500/50 hover:shadow-[0_0_15px_rgba(59,130,246,0.1)] transition-all gap-5 group">
                              ...
                              <div className="shrink-0 w-full lg:w-auto">
                                {test.isFree ? (
                                  <Link href={`/dashboard/test-series/railway-group-d`} className="w-full lg:w-auto px-6 py-3 bg-blue-600/10 border border-blue-500/30 hover:bg-blue-600 hover:text-white text-blue-400 font-bold rounded-xl transition-colors flex items-center justify-center text-sm shadow-sm active:scale-95">
            ...
            <div className="bg-slate-900 rounded-3xl p-8 border border-slate-800 shadow-xl relative overflow-hidden">
              ...
              <h2 className="text-2xl md:text-3xl font-black text-white mb-6 relative z-10">About RRB Group D 2026</h2>
              <p className="text-slate-400 font-medium leading-relaxed mb-8 relative z-10 text-lg">
                Railway Recruitment Board (RRB) Group D exam is conducted to recruit eligible candidates for various Level-1 posts in the Indian Railways. It is a highly competitive exam offering a secure central government job.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 relative z-10">
                ...
                <div className="p-5 bg-slate-950/50 rounded-2xl border border-slate-800 hover:border-slate-700 transition-colors">
                  <div className="text-[10px] text-slate-500 font-black uppercase tracking-widest mb-1.5 flex items-center gap-1.5">
                    <FileText className="w-3.5 h-3.5 text-emerald-400" /> Total Questions
                  </div>
                  <div className="font-bold text-white text-lg">100 Multiple Choice</div>
                </div>
                <div className="p-5 bg-slate-950/50 rounded-2xl border border-slate-800 hover:border-slate-700 transition-colors">
                  <div className="text-[10px] text-slate-500 font-black uppercase tracking-widest mb-1.5 flex items-center gap-1.5">
          ...
          <div className="lg:col-span-4" id="pricing">
            <div className="sticky top-24 bg-slate-900 border-2 border-blue-600 rounded-3xl p-8 shadow-[0_0_40px_rgba(37,99,235,0.15)] relative overflow-hidden">
              ...
              <p className="text-sm text-slate-400 font-medium mb-8 relative z-10">Unlock all RRB Group D mocks, sectional tests, PYQs, and detailed analytics to boost your score.</p>
              ...
              <div className="space-y-4 mb-8 p-6 bg-slate-950 rounded-2xl border border-slate-800 relative z-10">
                <div className="flex items-start gap-3 text-sm text-white font-medium">
                  <CheckCircle2 className="w-5 h-5 text-emerald-400 shrink-0 mt-0.5" /> Full Access to 65+ Tests
                </div>
                <div className="flex items-start gap-3 text-sm text-white font-medium">
                  <CheckCircle2 className="w-5 h-5 text-emerald-400 shrink-0 mt-0.5" /> Real CBT Interface replication
                </div>
                <div className="flex items-start gap-3 text-sm text-white font-medium">
              ...
              <Link href="/checkout?plan=pro&exam=rrb-group-d" className="block w-full py-5 bg-blue-600 hover:bg-blue-500 text-white font-black rounded-xl text-center transition-all text-lg shadow-lg shadow-blue-500/30 active:scale-95 relative z-10">
                Buy Xamsathi Pro
              </Link>
            ...
            <div className="mt-6 p-6 sm:p-8 bg-slate-900 rounded-3xl border border-slate-800 shadow-xl">
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 shrink-0 rounded-2xl bg-indigo-500/10 border border-indigo-500/20 flex items-center justify-center shadow-sm text-sm font-black text-indigo-400">96%</div>
