...
const testBreakdown = [
  {
    id: "cbt1-full",
    title: "RRB ALP CBT 1 Full Mock Tests",
    desc: "Strictly based on the latest CBT 1 pattern. Includes negative marking (1/3rd).",
    testCount: 25,
    freeCount: 1,
    tests: [
      { name: "RRB ALP CBT-1 Full Mock Test 1", q: 75, m: 75, time: "60 Mins", isFree: true },
      { name: "RRB ALP CBT-1 Full Mock Test 2", q: 75, m: 75, time: "60 Mins", isFree: false },
      { name: "RRB ALP CBT-1 Full Mock Test 3", q: 75, m: 75, time: "60 Mins", isFree: false },
      { name: "RRB ALP CBT-1 Full Mock Test 4", q: 75, m: 75, time: "60 Mins", isFree: false },
      { name: "RRB ALP CBT-1 Full Mock Test 5", q: 75, m: 75, time: "60 Mins", isFree: false },
    ]
  },
  {
    id: "pyq-tests",
    title: "RRB ALP Previous Year Papers",
    desc: "Official papers from RRB ALP previous exams (2018), set as timed mocks.",
    testCount: 18,
    freeCount: 1,
    tests: [
      { name: "RRB ALP CBT-1 (9th Aug 2018 - Shift 1)", q: 75, m: 75, time: "60 Mins", isFree: true },
      { name: "RRB ALP CBT-1 (9th Aug 2018 - Shift 2)", q: 75, m: 75, time: "60 Mins", isFree: false },
      { name: "RRB ALP CBT-1 (10th Aug 2018 - Shift 1)", q: 75, m: 75, time: "60 Mins", isFree: false },
    ]
  },
  {
    id: "sectional-tests",
    title: "Sectional Tests - Maths & Reasoning",
    desc: "Topic-wise tests to improve logic, mathematical foundational concepts, and speed.",
    testCount: 35,
    freeCount: 2,
    tests: [
      { name: "Mathematics: Number System", q: 20, m: 20, time: "20 Mins", isFree: true },
      { name: "Reasoning: Blood Relations", q: 25, m: 25, time: "20 Mins", isFree: true },
      { name: "Mathematics: Algebra & Geometry", q: 20, m: 20, time: "20 Mins", isFree: false },
    ]
  },
  {
    id: "cbt2-full",
    title: "RRB ALP CBT 2 (Part A & Part B)",
    desc: "Comprehensive mocks covering Basic Science & Engineering, and relevant Trade subjects.",
    testCount: 15,
    freeCount: 1,
    tests: [
      { name: "CBT-2 Part A Full Mock Test 1", q: 100, m: 100, time: "90 Mins", isFree: true },
      { name: "CBT-2 Part B (Electrician Trade) Mock 1", q: 75, m: 75, time: "60 Mins", isFree: false },
      { name: "CBT-2 Part B (Fitter Trade) Mock 1", q: 75, m: 75, time: "60 Mins", isFree: false },
    ]
  }
];

const faqs = [
  { q: "Is this test series bilingual?", a: "Yes, all our basic mock tests and sections are available in both English and Hindi. Trade specific questions may vary depending on the chosen technical subject." },
  { q: "What is the validity of the plans?", a: "The Pro plan comes with 12 Months validity, All-India Rank, and detailed analytics covering both CBT 1 and CBT 2 formats. A 6 Months pass is also available." },
  { q: "Are the questions based on the latest Railway pattern?", a: "Absolutely. All mock tests (both CBT 1 and CBT 2) are modeled to reflect the exact difficulty index and pattern prescribed by the RRB." },
  { q: "Can I access this test series on my mobile phone?", a: "Yes, the platform is fully responsive. You can flawlessly attempt tests and review your performance on any mobile or tablet device." }
];

export default function RRBALPPage() {
  const [activeAccordion, setActiveAccordion] = useState<string>("cbt1-full");
    ...
    <div className="min-h-screen bg-slate-950 text-slate-200 font-sans selection:bg-blue-500/30">
      ...
      <main className="container mx-auto px-4 md:px-6 pt-24 pb-20">
        ...
        <div className="flex items-center gap-2 text-sm text-slate-400 mb-6 font-medium">
          ...
          <span>›</span>
          <Link href="/government-exams/railway" className="hover:text-blue-400">Railway Exams</Link>
          <span>›</span>
          <span className="text-white font-bold">RRB ALP Test Series</span>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-8 space-y-10">
            ...
            <div className="bg-slate-900 rounded-3xl p-8 border border-slate-800 shadow-xl relative overflow-hidden group">
              ...
              <div className="relative z-10">
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-white mb-4 tracking-tight leading-tight">
                  RRB ALP Mock Test Series 2026
                </h1>

                <p className="text-lg text-slate-400 mb-6 font-medium leading-relaxed max-w-2xl">
                  Boost your RRB ALP (Assistant Loco Pilot) CBT 1 & CBT 2 preparation with India's most trusted mock tests strictly based on the latest Railway exam pattern. Get detailed solutions, All India Ranks, and deep performance analytics.
                </p>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                  <div className="flex flex-col items-center justify-center p-4 bg-slate-950/50 rounded-2xl border border-slate-800/50 text-center hover:border-slate-700 transition-colors">
                    ...
                    <span className="font-extrabold text-2xl text-white">78+</span>
                  ...
                  <div className="flex flex-col items-center justify-center p-4 bg-slate-950/50 rounded-2xl border border-slate-800/50 text-center hover:border-slate-700 transition-colors">
                    ...
                    <span className="font-extrabold text-2xl text-white">5+</span>
                  ...
                  <div className="flex flex-col items-center justify-center p-4 bg-slate-950/50 rounded-2xl border border-slate-800/50 text-center hover:border-slate-700 transition-colors">
                    ...
                    <span className="font-extrabold text-2xl text-white">CBT</span>
                    <span className="text-[10px] text-slate-500 font-bold uppercase tracking-widest mt-1">Pattern</span>
                  </div>
                </div>

                <div className="flex flex-col sm:flex-row items-center gap-4">
                  <Link href="/dashboard/test-series/railway-alp" className="w-full sm:w-auto px-8 py-4 bg-blue-600 hover:bg-blue-500 text-white font-black rounded-xl transition-all flex items-center justify-center gap-2 text-lg shadow-lg shadow-blue-500/20 active:scale-95">
                    <Play className="w-5 h-5 fill-white" /> Start Free Demo
                  </Link>
                  <Link href="/government-exams/railway/alp/schedule" className="w-full sm:w-auto px-8 py-4 bg-slate-950 border border-slate-700 hover:border-slate-500 hover:text-white text-slate-300 font-bold rounded-xl transition-all flex items-center justify-center gap-2 text-lg active:scale-95 shadow-sm">
                ...
                <div className="text-sm font-semibold text-slate-400 flex items-center justify-start gap-2 mt-4 px-2">
                  ...
                  Strictly per Latest RRB Pattern
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-900 rounded-3xl border border-slate-800 shadow-xl overflow-hidden" id="test-syllabus">
              <div className="p-6 md:p-8 border-b border-slate-800 bg-slate-900/50 relative overflow-hidden">
                ...
                <p className="text-slate-400 mt-2 font-medium relative z-10">Explore everything included in the RRB ALP Test Series package.</p>
              </div>
                          ...
                          {category.tests.map((test, idx) => (
                            <div key={idx} className="flex flex-col xl:flex-row xl:items-center justify-between p-5 bg-slate-900 border border-slate-800 rounded-2xl hover:border-blue-500/50 hover:shadow-[0_0_15px_rgba(59,130,246,0.1)] transition-all gap-5 group">
                              ...
                              <div className="shrink-0 w-full xl:w-auto">
                                {test.isFree ? (
                                  <Link href={`/dashboard/test-series/railway-alp`} className="w-full xl:w-auto px-6 py-3 bg-blue-600/10 border border-blue-500/30 hover:bg-blue-600 hover:text-white text-blue-400 font-bold rounded-xl transition-colors flex items-center justify-center text-sm shadow-sm active:scale-95">
            ...
            <div className="bg-slate-900 rounded-3xl p-8 border border-slate-800 shadow-xl relative overflow-hidden">
              ...
              <h2 className="text-2xl md:text-3xl font-black text-white mb-6 relative z-10">About RRB ALP 2026</h2>
              <p className="text-slate-400 font-medium leading-relaxed mb-8 relative z-10 text-lg">
                The Railway Recruitment Board (RRB) Assistant Loco Pilot (ALP) is one of the most sought-after technical jobs. The exam involves CBT 1 (Qualifying), CBT 2 (Merit determining Part A & Trade specific Part B), and CBAT (Psychometric Test).
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 relative z-10">
                ...
                <div className="p-5 bg-slate-950/50 rounded-2xl border border-slate-800 hover:border-slate-700 transition-colors">
                  <div className="text-[10px] text-slate-500 font-black uppercase tracking-widest mb-1.5 flex items-center gap-1.5">
                    <FileText className="w-3.5 h-3.5 text-emerald-400" /> Multiple Tiers
                  </div>
                  <div className="font-bold text-white text-lg">CBT 1, CBT 2 & CBAT</div>
                </div>
                <div className="p-5 bg-slate-950/50 rounded-2xl border border-slate-800 hover:border-slate-700 transition-colors">
                  <div className="text-[10px] text-slate-500 font-black uppercase tracking-widest mb-1.5 flex items-center gap-1.5">
                    <Clock className="w-3.5 h-3.5 text-rose-400" /> Negative Marking
                  </div>
                  <div className="font-bold text-white text-lg">1/3rd in CBTs</div>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-4" id="pricing">
            <div className="sticky top-24 bg-slate-900 border-2 border-blue-600 rounded-3xl p-8 shadow-[0_0_40px_rgba(37,99,235,0.15)] relative overflow-hidden">
              ...
              <p className="text-sm text-slate-400 font-medium mb-8 relative z-10">Unlock all RRB ALP mocks (CBT 1 & CBT 2), Trade specific tests, PYQs, and detailed analytics to boost your score.</p>
              ...
              <div className="space-y-4 mb-8 relative z-10">
                <div className="flex justify-between items-center p-5 rounded-2xl border-2 border-blue-500 bg-blue-600/10 cursor-pointer relative overflow-hidden transition-all hover:bg-blue-600/20 group">
                  ...
                  <div className="text-right">
                    <div className="text-3xl font-black text-blue-400 tracking-tight">₹899</div>
                  </div>
                </div>
              ...
              <div className="space-y-4 mb-8 p-6 bg-slate-950 rounded-2xl border border-slate-800 relative z-10">
                <div className="flex items-start gap-3 text-sm text-white font-medium">
                  <CheckCircle2 className="w-5 h-5 text-emerald-400 shrink-0 mt-0.5" /> Full Access to 78+ Tests
                </div>
                <div className="flex items-start gap-3 text-sm text-white font-medium">
                  <CheckCircle2 className="w-5 h-5 text-emerald-400 shrink-0 mt-0.5" /> Both CBT 1 & CBT 2 Tests
                </div>
                <div className="flex items-start gap-3 text-sm text-white font-medium">
              ...
              <Link href="/checkout?plan=pro&exam=rrb-alp" className="block w-full py-5 bg-blue-600 hover:bg-blue-500 text-white font-black rounded-xl text-center transition-all text-lg shadow-lg shadow-blue-500/30 active:scale-95 relative z-10">
                Buy Xamsathi Pro
              </Link>
            ...
            <div className="mt-6 p-6 sm:p-8 bg-slate-900 rounded-3xl border border-slate-800 shadow-xl">
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 shrink-0 rounded-2xl bg-indigo-500/10 border border-indigo-500/20 flex items-center justify-center shadow-sm text-sm font-black text-indigo-400">97%</div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-sm font-bold text-slate-300 leading-snug">Highest rated mock test platform for Railway exams</div>
                </div>
              </div>
            </div>
