...
export default function Railway_ALPPage() {
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-3xl w-full max-w-4xl max-h-[90vh] overflow-y-auto relative animate-in fade-in zoom-in duration-300">
            ...
            <div className="p-8 md:p-10">
              <div className="text-center mb-10">
                ...
                <p className="text-slate-400">Select the plan for RRB ALP.</p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-slate-950 border border-slate-800 rounded-2xl p-6 relative flex flex-col">
                  ...
                  <Link href="/checkout?plan=basic&exam=alp" className="w-full py-3 bg-slate-800 hover:bg-slate-700 text-white font-bold rounded-xl text-center transition-colors">Select Basic</Link>
                </div>
                ...
                <div className="bg-slate-900 border-2 border-blue-600 rounded-2xl p-6 relative flex flex-col md:-translate-y-4 shadow-xl">
                  ...
                  <Link href="/checkout?plan=pro&exam=alp" className="w-full py-3 bg-blue-600 hover:bg-blue-500 text-white font-black rounded-xl text-center transition-colors">Select Pro</Link>
                </div>

                {/* Premium */}
                <div className="bg-slate-950 border border-slate-800 rounded-2xl p-6 relative flex flex-col">
                  <h4 className="text-xl font-bold text-white mb-2">Premium</h4>
                  <div className="text-3xl font-black text-amber-400 mb-6">₹1099</div>
                  <div className="space-y-4 mb-8 flex-1">
                  ...
                  <Link href="/checkout?plan=premium&exam=alp" className="w-full py-3 bg-slate-800 hover:bg-slate-700 text-amber-400 font-bold rounded-xl text-center transition-colors">Select Premium</Link>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center max-w-7xl mx-auto">
            ...
            <div className="lg:col-span-7 text-center lg:text-left">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-7xl font-black text-white mb-6 tracking-tight">
                RRB ALP 2026 <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-400">Test Series</span>
              </h1>
              
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-6 mb-8 text-slate-300">
                <div className="flex items-center gap-2"><Trophy className="w-5 h-5 text-amber-400" /><span className="font-bold text-lg">78+ Tests</span></div>
                <div className="w-1.5 h-1.5 rounded-full bg-slate-700"></div>
                <div className="flex items-center gap-2"><BookOpen className="w-5 h-5 text-emerald-400" /><span className="font-bold text-lg">25 Full Mocks</span></div>
                <div className="w-1.5 h-1.5 rounded-full bg-slate-700"></div>
              ...
              <div className="bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800 rounded-3xl p-8 shadow-2xl relative z-10 text-center flex flex-col items-center">
                ...
                <div className="w-full space-y-3 mb-8 text-left">
                  <div className="flex items-start gap-3 text-slate-300 font-medium">
                    <CheckCircle2 className="w-5 h-5 text-blue-400 shrink-0" /> Full Access to All 78+ Tests
                  </div>
                  <div className="flex items-start gap-3 text-slate-300 font-medium">
      ...
      <section className="py-24 bg-slate-900 border-b border-slate-800">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-16">
             ...
             <p className="text-slate-400 text-lg">Everything you will receive upon RRB ALP enrollment.</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-slate-950 border border-slate-800 p-8 rounded-3xl hover:border-slate-700 transition-colors">
              ...
              <div className="text-4xl font-black text-amber-400 mb-2">18</div>
            ...
            <div className="bg-slate-950 border border-slate-800 p-8 rounded-3xl hover:border-slate-700 transition-colors">
              ...
              <ul className="text-slate-400 text-sm space-y-1">
                {["CBT-1 + CBT-2 Match","Technical Paper Practice included","Strict Timing Focus"].map((s,i) => <li key={i}>• {s}</li>)}
              </ul>
            </div>
          </div>
        </div>
             ...
             <div className="bg-slate-950 rounded-3xl border border-slate-800 overflow-hidden shadow-2xl">
                <table className="w-full text-center">
                  ...
                  <tbody className="text-slate-300">
                    <tr className="border-b border-slate-800/50"><td className="p-6 font-bold">Full Mock</td><td className="p-6 font-black text-white">25</td><td className="p-6 font-bold text-slate-500">90 min</td></tr>
                    <tr className="border-b border-slate-800/50"><td className="p-6 font-bold">Sectional Tests</td><td className="p-6 font-black text-white">35</td><td className="p-6 font-bold text-slate-500">30 min</td></tr>
                    <tr className="border-b border-slate-800/50"><td className="p-6 font-bold">PYQ</td><td className="p-6 font-black text-white">18</td><td className="p-6 font-bold text-slate-500">90 min</td></tr>
                  </tbody>
                </table>
             </div>
         </div>
      ...
      <section id="demo" className="py-24 bg-slate-950 border-b border-slate-800 text-center relative">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto bg-slate-900 border border-slate-800 rounded-3xl p-12 shadow-2xl">
             ...
             <p className="text-slate-400 mb-8 max-w-md mx-auto">1 Free Full-Length RRB ALP Mock. Experience the precise CBT interface.</p>
