                                            ...
                                            <div className="px-6 md:px-8 pb-8 pt-4 bg-slate-950/30 border-t border-slate-800/50 shadow-inner">
                                                ...
                                                <div className="space-y-4">
                                                    {category.tests.map((test, idx) => (
                                                        <div key={idx} className="flex flex-col lg:flex-row lg:items-center justify-between p-4 md:p-5 bg-slate-900 border border-slate-800 rounded-2xl hover:border-red-500/50 hover:shadow-[0_0_15px_rgba(239,68,68,0.1)] transition-all gap-5 group">
                                                            <div>
                                                            ...
                                                            <div className="shrink-0 w-full lg:w-auto">
                                                                {test.isFree ? (
                                                                    <Link href={`/dashboard/test-series/uppsc`} className="w-full lg:w-auto px-6 py-3 bg-red-600/10 border border-red-500/30 hover:bg-red-600 hover:text-white text-red-500 font-bold rounded-xl transition-colors flex items-center justify-center text-sm shadow-sm active:scale-95">
