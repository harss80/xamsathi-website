                                            ...
                                            <div className="px-6 md:px-8 pb-8 pt-4 bg-slate-950/30 border-t border-slate-800/50 shadow-inner">
                                                ...
                                                <div className="space-y-4">
                                                    {category.tests.map((test, idx) => (
                                                        <div key={idx} className="flex flex-col xl:flex-row xl:items-center justify-between p-5 bg-slate-900 border border-slate-800 rounded-2xl hover:border-amber-500/50 hover:shadow-[0_0_15px_rgba(245,158,11,0.1)] transition-all gap-5 group">
                                                            <div>
                                                            ...
                                                            <div className="shrink-0 w-full xl:w-auto">
                                                                {test.isFree ? (
                                                                    <Link href={`/dashboard/test-series/bpsc`} className="w-full xl:w-auto px-6 py-3 bg-amber-500/10 border border-amber-500/30 hover:bg-amber-500 hover:text-amber-950 text-amber-500 font-bold rounded-xl transition-colors flex items-center justify-center text-sm shadow-sm active:scale-95">
