...
const testBreakdown = [
    {
        ...
        desc: "Strictly based on the latest RPSC RAS pattern. Extensive coverage of Rajasthan History, Culture, Geography and Economy.",
        testCount: 20,
        freeCount: 1,
        tests: [
            { name: "RPSC RAS Prelims Full Mock 1", q: 150, m: 200, time: "180 Mins", isFree: true },
            { name: "RPSC RAS Prelims Full Mock 2", q: 150, m: 200, time: "180 Mins", isFree: false },
            { name: "RPSC RAS Prelims Full Mock 3", q: 150, m: 200, time: "180 Mins", isFree: false },
            { name: "RPSC RAS Prelims Full Mock 4", q: 150, m: 200, time: "180 Mins", isFree: false },
            { name: "RPSC RAS Prelims Full Mock 5", q: 150, m: 200, time: "180 Mins", isFree: false },
        ]
    },
    {
        id: "pyq-tests",
        title: "RPSC RAS Previous Year Papers",
        desc: "Official papers from RAS 2023, 2021, and 2018 exams provided as timed real-interface mocks.",
        testCount: 8,
        freeCount: 1,
        tests: [
            { name: "Official RPSC RAS Prelims 2023", q: 150, m: 200, time: "180 Mins", isFree: true },
            { name: "Official RPSC RAS Prelims 2021", q: 150, m: 200, time: "180 Mins", isFree: false },
            { name: "Official RPSC RAS Prelims 2018", q: 150, m: 200, time: "180 Mins", isFree: false },
        ]
    },
    {
        id: "rajasthan-gk-special",
        title: "Sectional Tests - Rajasthan Special GK",
        desc: "Focused tests on Rajasthan Art & Culture, History, Geography, and the latest Rajasthan Economic Review.",
        testCount: 25,
        freeCount: 2,
        tests: [
            { name: "Rajasthan Art, Culture & Tradition", q: 40, m: 40, time: "40 Mins", isFree: true },
            { name: "Rajasthan Geography & Soils", q: 40, m: 40, time: "40 Mins", isFree: true },
            { name: "Rajasthan Economy & Industrial Growth", q: 40, m: 40, time: "40 Mins", isFree: false },
        ]
    }
];

const faqs = [
    { q: "Is this test series bilingual?", a: "Yes, all mock tests for RPSC RAS are available in both English and Hindi. The Rajasthan-specific GK tests are also bilingual with detailed explanations." },
    { q: "What is the validity of the plans?", a: "Basic plan offers 6 months access. Pro and Premium plans offer longer validity and additional features like Rajasthan Rank Prediction." },
    { q: "Does the series cover the Rajasthan Economic Review?", a: "Yes, we include specialized tests based on the latest Rajasthan Economic Review and Budget, which are vital for the RAS exam." },
    { q: "Are there tests for the Mains exam too?", a: "The current series focuses on the Prelims exam. We launch dedicated Mains answer-writing practice programs separately after the Prelims." }
];
        ...
        <div className="min-h-screen bg-slate-950 text-slate-200 font-sans selection:bg-rose-500/30">
            ...
            <main className="container mx-auto px-4 md:px-6 pt-24 pb-20">
                ...
                <div className="flex flex-wrap items-center gap-2 text-sm text-slate-400 mb-6 font-medium">
                    ...
                    <span>›</span>
                    <span className="text-white font-bold">RPSC RAS Mock Test Series</span>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                    ...
                    <div className="lg:col-span-8 space-y-10">
                        ...
                        <div className="bg-slate-900 rounded-3xl p-8 border border-slate-800 shadow-xl relative overflow-hidden group">
                            ...
                            <div className="relative z-10">
                                <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-md bg-rose-500/10 border border-rose-500/20 text-rose-500 text-xs font-bold mb-5 uppercase tracking-wider">
                                ...
                                <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-white mb-4 tracking-tight leading-tight">
                                    RPSC RAS Prelims Test Series 2026
                                </h1>

                                <p className="text-lg text-slate-400 mb-6 font-medium leading-relaxed max-w-2xl">
                                    Ace the Rajasthan Administrative Services exam with India's most researched mock tests focused on Rajasthan's culture, history and dynamic current affairs.
                                </p>

                                <div className="flex flex-wrap items-center gap-6 mb-8 text-sm">
                                    <div className="flex items-center gap-2 font-bold text-slate-200">
                                        <Star className="w-5 h-5 text-rose-400 fill-rose-400" />
                                        4.9 <span className="text-slate-500 font-medium">(14,500+ Ratings)</span>
                                    </div>
                                    <div className="flex items-center gap-2 font-bold text-slate-200">
                                ...
                                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                                    <div className="flex flex-col items-center justify-center p-4 bg-slate-950/50 rounded-2xl border border-slate-800/50 text-center hover:border-slate-700 transition-colors">
                                        ...
                                        <span className="font-extrabold text-2xl text-white">150+</span>
                                    ...
                                    <div className="flex flex-col items-center justify-center p-4 bg-slate-950/50 rounded-2xl border border-slate-800/50 text-center hover:border-slate-700 transition-colors">
                                        ...
                                        <span className="font-extrabold text-2xl text-white">RPSC</span>
                        ...
                        <div className="bg-slate-900 rounded-3xl border border-slate-800 shadow-xl overflow-hidden" id="test-syllabus">
                            <div className="p-6 md:p-8 border-b border-slate-800 bg-slate-900/50 relative overflow-hidden">
                                ...
                                <p className="text-slate-400 mt-2 font-medium relative z-10">Explore everything included in the RPSC RAS Test Series package.</p>
                            </div>
                                            ...
                                            <div className="px-6 md:px-8 pb-8 pt-4 bg-slate-950/30 border-t border-slate-800/50 shadow-inner">
                                                ...
                                                <div className="space-y-4">
                                                    {category.tests.map((test, idx) => (
                                                        <div key={idx} className="flex flex-col lg:flex-row lg:items-center justify-between p-4 md:p-5 bg-slate-900 border border-slate-800 rounded-2xl hover:border-rose-500/50 hover:shadow-[0_0_15px_rgba(225,29,72,0.1)] transition-all gap-5 group">
                                                            <div>
                                                            ...
                                                            <div className="shrink-0 w-full lg:w-auto">
                                                                {test.isFree ? (
                                                                    <Link href={`/dashboard/test-series/rpsc-ras`} className="w-full lg:w-auto px-6 py-3 bg-rose-600/10 border border-rose-500/30 hover:bg-rose-600 hover:text-white text-rose-400 font-bold rounded-xl transition-colors flex items-center justify-center text-sm shadow-sm active:scale-95">
                        ...
                        <div className="bg-slate-900 rounded-3xl p-8 border border-slate-800 shadow-xl relative overflow-hidden">
                            <div className="absolute top-0 right-0 w-64 h-64 bg-rose-500/5 rounded-full blur-3xl -mr-32 -mt-32"></div>
                            <h2 className="text-2xl md:text-3xl font-black text-white mb-6 relative z-10">About RPSC RAS Exam 2026</h2>
                            <p className="text-slate-400 font-medium leading-relaxed mb-8 relative z-10 text-lg">
                                The Rajasthan Administrative Service (RAS) is the premier state-level civil service for Rajasthan. Conducted by RPSC, selection involves a Prelims exam (single GS paper of 200 marks) followed by written Mains and an Interview.
                            </p>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 relative z-10">
                                ...
                                <div className="p-5 bg-slate-950/50 rounded-2xl border border-slate-800 hover:border-slate-700 transition-colors">
                                    ...
                                    <div className="font-bold text-white text-lg">Single GS Paper (150 Q)</div>
                                </div>
                                <div className="p-5 bg-slate-950/50 rounded-2xl border border-slate-800 hover:border-slate-700 transition-colors">
                                    <div className="text-[10px] text-slate-500 font-black uppercase tracking-widest mb-1.5 flex items-center gap-1.5">
                                        <Clock className="w-3.5 h-3.5 text-red-400" /> Negative Marking
                                    </div>
                                    <div className="font-bold text-white text-lg">1/3rd Penalty</div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="lg:col-span-4" id="pricing">
                        <div className="sticky top-24 bg-slate-900 border-2 border-rose-600 rounded-3xl p-8 shadow-[0_0_40px_rgba(225,29,72,0.15)] relative overflow-hidden">
                            ...
                            <h3 className="text-2xl font-black text-white mb-3 mt-3 relative z-10">Get RPSC Pro Pass</h3>
                            <p className="text-sm text-slate-400 font-medium mb-8 relative z-10">Unlock all RPSC mocks, Rajasthan special tests, PYQs, and detailed analytics to dominate your exam.</p>
                            ...
                            <div className="space-y-4 mb-8 relative z-10">
                                <div className="flex justify-between items-center p-5 rounded-2xl border-2 border-rose-500 bg-rose-600/10 cursor-pointer relative overflow-hidden transition-all hover:bg-rose-600/20 group">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-xs font-bold text-slate-400 line-through mt-0.5">₹2499</div>
                                    </div>
                                    <div className="text-right">
                                        <div className="text-3xl font-black text-rose-400 tracking-tight">₹999</div>
                                    </div>
                                </div>
                                ...
                                <div className="flex justify-between items-center p-5 rounded-2xl border border-slate-700 hover:border-slate-500 bg-slate-950/50 cursor-pointer transition-colors group">
                                    <div>
                                        ...
                                        <div className="text-xs font-bold text-slate-500 line-through mt-0.5">₹1499</div>
                                    </div>
                                    <div className="text-right">
                                        <div className="text-2xl font-black text-slate-300 group-hover:text-white transition-colors">₹699</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="space-y-4 mb-8 p-6 bg-slate-950 rounded-2xl border border-slate-800 relative z-10">
                                <div className="flex items-start gap-3 text-sm text-white font-medium">
                                    <CheckCircle2 className="w-5 h-5 text-emerald-400 shrink-0 mt-0.5" /> Full Access to 150+ Tests
                                </div>
                                <div className="flex items-start gap-3 text-sm text-white font-medium">
                                    <CheckCircle2 className="w-5 h-5 text-emerald-400 shrink-0 mt-0.5" /> Rajasthan Special GK Coverage
                                </div>
                                <div className="flex items-start gap-3 text-sm text-white font-medium">
                                    <CheckCircle2 className="w-5 h-5 text-emerald-400 shrink-0 mt-0.5" /> Rajasthan State Ranking
                                </div>
                                <div className="flex items-start gap-3 text-sm text-white font-medium">
                            ...
                            <Link href="/checkout?plan=pro&exam=rpsc-ras" className="block w-full py-5 bg-rose-600 hover:bg-rose-500 text-white font-black rounded-xl text-center transition-all text-lg shadow-lg shadow-rose-500/30 active:scale-95 relative z-10">
                                Buy RPSC Pro
                            </Link>
                        ...
                        <div className="mt-6 p-6 sm:p-8 bg-slate-900 rounded-3xl border border-slate-800 shadow-xl">
                            ...
                            <div className="space-y-6">
                                <div className="flex items-center gap-4">
                                    <div className="w-12 h-12 shrink-0 rounded-2xl bg-rose-500/10 border border-rose-500/20 flex items-center justify-center shadow-sm text-sm font-black text-rose-500">97%</div>
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="text-sm font-bold text-slate-300 leading-snug">Highest rated mock test platform for RPSC</div>
                                </div>
                            </div>
                        </div>
