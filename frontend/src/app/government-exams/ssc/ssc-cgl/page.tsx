    ...
    <div className="min-h-screen bg-slate-950 text-slate-200 font-sans selection:bg-blue-500/30">
      ...
      <main className="container mx-auto px-4 md:px-6 pt-24 pb-20">
        ...
        <div className="flex items-center gap-2 text-sm text-slate-400 mb-6 font-medium">
          ...
          <span>›</span>
          <span className="text-white font-bold">SSC CGL Test Series</span>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-8 space-y-10">
            ...
            <div className="bg-slate-900 rounded-3xl p-8 border border-slate-800 shadow-xl relative overflow-hidden group">
              ...
              <div className="relative z-10">
                ...
                <p className="text-lg text-slate-400 mb-6 font-medium leading-relaxed max-w-2xl">
                  Boost your SSC CGL Tier 1 & Tier 2 preparation with India's most trusted mock tests strictly based on the latest TCS exam pattern. Get detailed solutions, All India Ranks, and deep performance analytics.
                </p>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                  <div className="flex flex-col items-center justify-center p-4 bg-slate-950/50 rounded-2xl border border-slate-800/50 text-center hover:border-slate-700 transition-colors">
                    ...
                    <span className="font-extrabold text-2xl text-white">450+</span>
                  ...
                  <div className="flex flex-col items-center justify-center p-4 bg-slate-950/50 rounded-2xl border border-slate-800/50 text-center hover:border-slate-700 transition-colors">
                    ...
                    <span className="font-extrabold text-2xl text-white">45+</span>
            ...
            <div className="bg-slate-900 rounded-3xl border border-slate-800 shadow-xl overflow-hidden" id="test-syllabus">
              <div className="p-6 md:p-8 border-b border-slate-800 bg-slate-900/50 relative overflow-hidden">
                ...
                <p className="text-slate-400 mt-2 font-medium relative z-10">Explore everything included in the SSC CGL Test Series package.</p>
              </div>
                          ...
                          {category.tests.map((test, idx) => (
                            <div key={idx} className="flex flex-col xl:flex-row xl:items-center justify-between p-5 bg-slate-900 border border-slate-800 rounded-2xl hover:border-blue-500/50 hover:shadow-[0_0_15px_rgba(59,130,246,0.1)] transition-all gap-5 group">
                              ...
                              <div className="shrink-0 w-full xl:w-auto">
                                {test.isFree ? (
                                  <Link href={`/dashboard/test-series/ssc-cgl`} className="w-full xl:w-auto px-6 py-3 bg-blue-600/10 border border-blue-500/30 hover:bg-blue-600 hover:text-white text-blue-400 font-bold rounded-xl transition-colors flex items-center justify-center text-sm shadow-sm active:scale-95">
            ...
            <div className="bg-slate-900 rounded-3xl p-8 border border-slate-800 shadow-xl relative overflow-hidden">
              ...
              <h2 className="text-2xl md:text-3xl font-black text-white mb-6 relative z-10">About SSC CGL 2026</h2>
          ...
          <div className="lg:col-span-4" id="pricing">
            <div className="sticky top-24 bg-slate-900 border-2 border-blue-600 rounded-3xl p-8 shadow-[0_0_40px_rgba(37,99,235,0.15)] relative overflow-hidden">
              ...
              <p className="text-sm text-slate-400 font-medium mb-8 relative z-10">Unlock all SSC CGL mocks, chapter tests, PYQs, and detailed analytics to boost your score.</p>
              ...
              <div className="space-y-4 mb-8 p-6 bg-slate-950 rounded-2xl border border-slate-800 relative z-10">
                <div className="flex items-start gap-3 text-sm text-white font-medium">
                  <CheckCircle2 className="w-5 h-5 text-emerald-400 shrink-0 mt-0.5" /> Full Access to 450+ Tests
                </div>
                <div className="flex items-start gap-3 text-sm text-white font-medium">
              ...
              <Link href="/checkout?plan=pro&exam=ssc-cgl" className="block w-full py-5 bg-blue-600 hover:bg-blue-500 text-white font-black rounded-xl text-center transition-all text-lg shadow-lg shadow-blue-500/30 active:scale-95 relative z-10">
                Buy Xamsathi Pro
              </Link>
