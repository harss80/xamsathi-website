...
const testBreakdown = [
  {
    id: "full-tests",
    title: "SSC MTS Full Mock Tests",
    desc: "Strictly based on the latest TCS pattern (Session I & Session II).",
    testCount: 20,
    freeCount: 1,
    tests: [
      { name: "SSC MTS Full Mock Test 1", q: 90, m: 270, time: "90 Mins", isFree: true },
      { name: "SSC MTS Full Mock Test 2", q: 90, m: 270, time: "90 Mins", isFree: false },
      { name: "SSC MTS Full Mock Test 3", q: 90, m: 270, time: "90 Mins", isFree: false },
      { name: "SSC MTS Full Mock Test 4", q: 90, m: 270, time: "90 Mins", isFree: false },
      { name: "SSC MTS Full Mock Test 5", q: 90, m: 270, time: "90 Mins", isFree: false },
    ]
  },
  {
    id: "pyq-2023",
    title: "SSC MTS Previous Year Papers (2023)",
    desc: "Official papers from SSC MTS 2023 exam, set as timed mocks.",
    testCount: 25,
    freeCount: 1,
    tests: [
      { name: "SSC MTS (1st September 2023 - Shift 1)", q: 90, m: 270, time: "90 Mins", isFree: true },
      { name: "SSC MTS (1st September 2023 - Shift 2)", q: 90, m: 270, time: "90 Mins", isFree: false },
      { name: "SSC MTS (1st September 2023 - Shift 3)", q: 90, m: 270, time: "90 Mins", isFree: false },
      { name: "SSC MTS (4th September 2023 - Shift 1)", q: 90, m: 270, time: "90 Mins", isFree: false },
    ]
  },
  {
    id: "maths-reasoning",
    title: "Sectional Tests - Session I (Maths & Reasoning)",
    desc: "Topic-wise and sectional practice to ensure you qualify Session I easily.",
    testCount: 30,
    freeCount: 2,
    tests: [
      { name: "Numerical Ability - Level 1", q: 20, m: 60, time: "20 Mins", isFree: true },
      { name: "Reasoning Ability - Basics", q: 20, m: 60, time: "20 Mins", isFree: true },
      { name: "Numerical & Reasoning Mix 1", q: 40, m: 120, time: "45 Mins", isFree: false },
      { name: "Advanced Arithmetic Topics", q: 20, m: 60, time: "25 Mins", isFree: false },
    ]
  },
  {
    id: "english-ga",
    title: "Sectional Tests - Session II (English & GA)",
    desc: "The merit-deciding sections. High quality practice questions to maximize your score.",
    testCount: 40,
    freeCount: 2,
    tests: [
      { name: "General English - Grammar Rules", q: 25, m: 75, time: "20 Mins", isFree: true },
      { name: "General Awareness - Current Affairs", q: 25, m: 75, time: "20 Mins", isFree: true },
      { name: "Static GK Mix 1", q: 25, m: 75, time: "20 Mins", isFree: false },
      { name: "English Comprehension Mix 1", q: 25, m: 75, time: "22 Mins", isFree: false },
    ]
  }
];

const faqs = [
  { q: "Is this test series bilingual?", a: "Yes, all tests in the SSC MTS Mock Test Series are available in both English and Hindi. You can switch the language anytime during the test." },
  { q: "Does Session I have negative marking?", a: "No, as per the latest TCS exam pattern, there is NO negative marking in Session I (Maths & Reasoning). However, Session II (English & GA) has a penalty of 1 mark for each wrong answer." },
  { q: "Are the questions based on the latest TCS pattern?", a: "Absolutely. All mock tests and sectional tests are updated strictly according to the latest SSC MTS & Havaldar pattern conducted by TCS." },
...
export default function SSCMTSExamPage() {
    ...
    <div className="min-h-screen bg-slate-950 text-slate-200 font-sans selection:bg-blue-500/30">
      ...
      <main className="container mx-auto px-4 md:px-6 pt-24 pb-20">
        ...
        <div className="flex items-center gap-2 text-sm text-slate-400 mb-6 font-medium">
          ...
          <span>›</span>
          <span className="text-white font-bold">SSC MTS Test Series</span>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-8 space-y-10">
            ...
            <div className="bg-slate-900 rounded-3xl p-8 border border-slate-800 shadow-xl relative overflow-hidden group">
              ...
              <div className="relative z-10">
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-white mb-4 tracking-tight leading-tight">
                  SSC MTS Mock Test Series 2026
                </h1>

                <p className="text-lg text-slate-400 mb-6 font-medium leading-relaxed max-w-2xl">
                  Boost your SSC MTS & Havaldar preparation with India's most trusted mock tests strictly based on the latest TCS exam pattern. Get detailed solutions, All India Ranks, and deep performance analytics.
                </p>

                <div className="flex flex-wrap items-center gap-6 mb-8 text-sm">
                  <div className="flex items-center gap-2 font-bold text-slate-200">
                    <Star className="w-5 h-5 text-amber-400 fill-amber-400" />
                    4.6 <span className="text-slate-500 font-medium">(8,500+ Ratings)</span>
                  </div>
                  <div className="flex items-center gap-2 font-bold text-slate-200">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                  <div className="flex flex-col items-center justify-center p-4 bg-slate-950/50 rounded-2xl border border-slate-800/50 text-center hover:border-slate-700 transition-colors">
                    ...
                    <span className="font-extrabold text-2xl text-white">250+</span>
                  ...
                  <div className="flex flex-col items-center justify-center p-4 bg-slate-950/50 rounded-2xl border border-slate-800/50 text-center hover:border-slate-700 transition-colors">
                    ...
                    <span className="font-extrabold text-2xl text-white">25+</span>
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4">
                  <Link href="/dashboard/test-series/ssc-mts" className="w-full sm:w-auto px-8 py-4 bg-blue-600 hover:bg-blue-500 text-white font-black rounded-xl transition-all flex items-center justify-center gap-2 text-lg shadow-lg shadow-blue-500/20 active:scale-95">
                    <Play className="w-5 h-5 fill-white" /> Start Free Demo
                  </Link>
                  <Link href="/government-exams/ssc/ssc-mts/schedule" className="w-full sm:w-auto px-8 py-4 bg-slate-950 border border-slate-700 hover:border-slate-500 hover:text-white text-slate-300 font-bold rounded-xl transition-all flex items-center justify-center gap-2 text-lg active:scale-95 shadow-sm">
            ...
            <div className="bg-slate-900 rounded-3xl border border-slate-800 shadow-xl overflow-hidden" id="test-syllabus">
              <div className="p-6 md:p-8 border-b border-slate-800 bg-slate-900/50 relative overflow-hidden">
                ...
                <p className="text-slate-400 mt-2 font-medium relative z-10">Explore everything included in the SSC MTS Test Series package.</p>
              </div>
                          ...
                          {category.tests.map((test, idx) => (
                            <div key={idx} className="flex flex-col xl:flex-row xl:items-center justify-between p-5 bg-slate-900 border border-slate-800 rounded-2xl hover:border-blue-500/50 hover:shadow-[0_0_15px_rgba(59,130,246,0.1)] transition-all gap-5 group">
                              ...
                              <div className="shrink-0 w-full xl:w-auto">
                                {test.isFree ? (
                                  <Link href={`/dashboard/test-series/ssc-mts`} className="w-full xl:w-auto px-6 py-3 bg-blue-600/10 border border-blue-500/30 hover:bg-blue-600 hover:text-white text-blue-400 font-bold rounded-xl transition-colors flex items-center justify-center text-sm shadow-sm active:scale-95">
            ...
            <div className="bg-slate-900 rounded-3xl p-8 border border-slate-800 shadow-xl relative overflow-hidden">
              ...
              <h2 className="text-2xl md:text-3xl font-black text-white mb-6 relative z-10">About SSC MTS 2026</h2>
              <p className="text-slate-400 font-medium leading-relaxed mb-8 relative z-10 text-lg">
                The Staff Selection Commission Multi-Tasking Staff (SSC MTS) is a prestigious national-level exam recruiting 10th pass candidates for various Group C non-gazetted, non-ministerial posts in various Ministries, Departments, and Offices of the Government of India.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 relative z-10">
                ...
                <div className="p-5 bg-slate-950/50 rounded-2xl border border-slate-800 hover:border-slate-700 transition-colors">
                  <div className="text-[10px] text-slate-500 font-black uppercase tracking-widest mb-1.5 flex items-center gap-1.5">
                    <FileText className="w-3.5 h-3.5 text-emerald-400" /> Structural Pattern
                  </div>
                  <div className="font-bold text-white text-lg">2 Sessions (Same Day)</div>
                </div>
                <div className="p-5 bg-slate-950/50 rounded-2xl border border-slate-800 hover:border-slate-700 transition-colors">
                  <div className="text-[10px] text-slate-500 font-black uppercase tracking-widest mb-1.5 flex items-center gap-1.5">
                    <Clock className="w-3.5 h-3.5 text-rose-400" /> Negative Marking
                  </div>
                  <div className="font-bold text-white text-lg">Session 2 Only (-1 Mark)</div>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-4" id="pricing">
            <div className="sticky top-24 bg-slate-900 border-2 border-blue-600 rounded-3xl p-8 shadow-[0_0_40px_rgba(37,99,235,0.15)] relative overflow-hidden">
              ...
              <p className="text-sm text-slate-400 font-medium mb-8 relative z-10">Unlock all SSC MTS mocks, chapter tests, PYQs, and detailed analytics to boost your score.</p>
              ...
              <div className="space-y-4 mb-8 p-6 bg-slate-950 rounded-2xl border border-slate-800 relative z-10">
                <div className="flex items-start gap-3 text-sm text-white font-medium">
                  <CheckCircle2 className="w-5 h-5 text-emerald-400 shrink-0 mt-0.5" /> Full Access to 250+ Tests
                </div>
                <div className="flex items-start gap-3 text-sm text-white font-medium">
              ...
              <Link href="/checkout?plan=pro&exam=ssc-mts" className="block w-full py-5 bg-blue-600 hover:bg-blue-500 text-white font-black rounded-xl text-center transition-all text-lg shadow-lg shadow-blue-500/30 active:scale-95 relative z-10">
                Buy Xamsathi Pro
              </Link>
