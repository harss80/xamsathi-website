...
const testBreakdown = [
  {
    id: "full-tests",
    title: "SSC CPO Tier 1 Full Mock Tests",
    desc: "Strictly based on the latest TCS pattern. Includes negative marking.",
    testCount: 20,
    freeCount: 1,
    tests: [
      { name: "SSC CPO Tier 1 Full Mock Test 1", q: 200, m: 200, time: "120 Mins", isFree: true },
      { name: "SSC CPO Tier 1 Full Mock Test 2", q: 200, m: 200, time: "120 Mins", isFree: false },
      { name: "SSC CPO Tier 1 Full Mock Test 3", q: 200, m: 200, time: "120 Mins", isFree: false },
      { name: "SSC CPO Tier 1 Full Mock Test 4", q: 200, m: 200, time: "120 Mins", isFree: false },
      { name: "SSC CPO Tier 1 Full Mock Test 5", q: 200, m: 200, time: "120 Mins", isFree: false },
    ]
  },
  {
    id: "pyq-2023",
    title: "SSC CPO Tier 1 Previous Year Papers (2023)",
    desc: "Official papers from SSC CPO 2023 exam, set as timed mocks.",
    testCount: 9,
    freeCount: 1,
    tests: [
      { name: "SSC CPO Tier 1 (3rd Oct 2023 - Shift 1)", q: 200, m: 200, time: "120 Mins", isFree: true },
      { name: "SSC CPO Tier 1 (3rd Oct 2023 - Shift 2)", q: 200, m: 200, time: "120 Mins", isFree: false },
      { name: "SSC CPO Tier 1 (4th Oct 2023 - Shift 1)", q: 200, m: 200, time: "120 Mins", isFree: false },
      { name: "SSC CPO Tier 1 (4th Oct 2023 - Shift 2)", q: 200, m: 200, time: "120 Mins", isFree: false },
    ]
  },
  {
    id: "quant-chapter",
    ...
    freeCount: 2,
    tests: [
      { name: "Percentage - Conceptual", q: 20, m: 20, time: "20 Mins", isFree: true },
      { name: "Ratio and Proportion", q: 20, m: 20, time: "20 Mins", isFree: true },
      { name: "Number System - Level 1", q: 20, m: 20, time: "20 Mins", isFree: false },
      { name: "Time and Work - Advanced", q: 20, m: 20, time: "20 Mins", isFree: false },
    ]
  },
  {
    ...
    freeCount: 1,
    tests: [
      { name: "Blood Relations", q: 20, m: 20, time: "15 Mins", isFree: true },
      { name: "Coding Decoding", q: 25, m: 25, time: "20 Mins", isFree: false },
      { name: "Syllogism", q: 20, m: 20, time: "15 Mins", isFree: false },
    ]
  }
];

const faqs = [
  { q: "Is this test series bilingual?", a: "Yes, all tests in the SSC CPO Mock Test Series are available in both English and Hindi. You can switch the language anytime during the test." },
  ...
  { q: "Are the questions based on the latest TCS pattern?", a: "Absolutely. All mock tests and sectional tests are updated strictly according to the latest SSC CPO pattern conducted by TCS." },
...
export default function SSCCPOExamPage() {
    ...
    <div className="min-h-screen bg-slate-950 text-slate-200 font-sans selection:bg-blue-500/30">
      ...
      <main className="container mx-auto px-4 md:px-6 pt-24 pb-20">
        ...
        <div className="flex items-center gap-2 text-sm text-slate-400 mb-6 font-medium">
          ...
          <span>›</span>
          <span className="text-white font-bold">SSC CPO Test Series</span>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-8 space-y-10">
            ...
            <div className="bg-slate-900 rounded-3xl p-8 border border-slate-800 shadow-xl relative overflow-hidden group">
              ...
              <div className="relative z-10">
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-white mb-4 tracking-tight leading-tight">
                  SSC CPO Mock Test Series 2026
                </h1>

                <p className="text-lg text-slate-400 mb-6 font-medium leading-relaxed max-w-2xl">
                  Boost your SSC CPO Tier 1 & Tier 2 preparation with India's most trusted mock tests strictly based on the latest TCS exam pattern. Get detailed solutions, All India Ranks, and deep performance analytics.
                </p>

                <div className="flex flex-wrap items-center gap-6 mb-8 text-sm">
                  <div className="flex items-center gap-2 font-bold text-slate-200">
                    <Star className="w-5 h-5 text-amber-400 fill-amber-400" />
                    4.8 <span className="text-slate-500 font-medium">(11,200+ Ratings)</span>
                  </div>
                  <div className="flex items-center gap-2 font-bold text-slate-200">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                  <div className="flex flex-col items-center justify-center p-4 bg-slate-950/50 rounded-2xl border border-slate-800/50 text-center hover:border-slate-700 transition-colors">
                    ...
                    <span className="font-extrabold text-2xl text-white">350+</span>
                  ...
                  <div className="flex flex-col items-center justify-center p-4 bg-slate-950/50 rounded-2xl border border-slate-800/50 text-center hover:border-slate-700 transition-colors">
                    ...
                    <span className="font-extrabold text-2xl text-white">35+</span>
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4">
                  <Link href="/dashboard/test-series/ssc-cpo" className="w-full sm:w-auto px-8 py-4 bg-blue-600 hover:bg-blue-500 text-white font-black rounded-xl transition-all flex items-center justify-center gap-2 text-lg shadow-lg shadow-blue-500/20 active:scale-95">
                    <Play className="w-5 h-5 fill-white" /> Start Free Demo
                  </Link>
                  <Link href="/government-exams/ssc/ssc-cpo/schedule" className="w-full sm:w-auto px-8 py-4 bg-slate-950 border border-slate-700 hover:border-slate-500 hover:text-white text-slate-300 font-bold rounded-xl transition-all flex items-center justify-center gap-2 text-lg active:scale-95 shadow-sm">
            ...
            <div className="bg-slate-900 rounded-3xl border border-slate-800 shadow-xl overflow-hidden" id="test-syllabus">
              <div className="p-6 md:p-8 border-b border-slate-800 bg-slate-900/50 relative overflow-hidden">
                ...
                <p className="text-slate-400 mt-2 font-medium relative z-10">Explore everything included in the SSC CPO Test Series package.</p>
              </div>
            ...
            <div className="bg-slate-900 rounded-3xl p-8 border border-slate-800 shadow-xl relative overflow-hidden">
              ...
              <h2 className="text-2xl md:text-3xl font-black text-white mb-6 relative z-10">About SSC CPO 2026</h2>
              <p className="text-slate-400 font-medium leading-relaxed mb-8 relative z-10 text-lg">
                The Staff Selection Commission Central Police Organization (SSC CPO) exam recruits candidates for sub-inspector posts in Delhi Police, CAPFs, and other police forces. It is highly competitive and prestigious.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 relative z-10">
                ...
                <div className="p-5 bg-slate-950/50 rounded-2xl border border-slate-800 hover:border-slate-700 transition-colors">
                  ...
                  <div className="font-bold text-white text-lg">4 Sections (200 Qs)</div>
                </div>
                <div className="p-5 bg-slate-950/50 rounded-2xl border border-slate-800 hover:border-slate-700 transition-colors">
                  <div className="text-[10px] text-slate-500 font-black uppercase tracking-widest mb-1.5 flex items-center gap-1.5">
                    <Clock className="w-3.5 h-3.5 text-rose-400" /> Negative Marking
                  </div>
                  <div className="font-bold text-white text-lg">0.25 Marks Penalty</div>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-4" id="pricing">
            <div className="sticky top-24 bg-slate-900 border-2 border-blue-600 rounded-3xl p-8 shadow-[0_0_40px_rgba(37,99,235,0.15)] relative overflow-hidden">
              ...
              <p className="text-sm text-slate-400 font-medium mb-8 relative z-10">Unlock all SSC CPO mocks, chapter tests, PYQs, and detailed analytics to boost your score.</p>
              ...
              <div className="space-y-4 mb-8 p-6 bg-slate-950 rounded-2xl border border-slate-800 relative z-10">
                <div className="flex items-start gap-3 text-sm text-white font-medium">
                  <CheckCircle2 className="w-5 h-5 text-emerald-400 shrink-0 mt-0.5" /> Full Access to 350+ Tests
                </div>
                <div className="flex items-start gap-3 text-sm text-white font-medium">
              ...
              <Link href="/checkout?plan=pro&exam=ssc-cpo" className="block w-full py-5 bg-blue-600 hover:bg-blue-500 text-white font-black rounded-xl text-center transition-all text-lg shadow-lg shadow-blue-500/30 active:scale-95 relative z-10">
                Buy Xamsathi Pro
              </Link>
            ...
            <div className="mt-6 p-6 sm:p-8 bg-slate-900 rounded-3xl border border-slate-800 shadow-xl">
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 shrink-0 rounded-2xl bg-indigo-500/10 border border-indigo-500/20 flex items-center justify-center shadow-sm text-sm font-black text-indigo-400">95%</div>
