      ...
      <section className="py-20 bg-slate-900 border-b border-slate-800">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-black text-white mb-6">About SSC CGL Exam</h2>
              <p className="text-slate-400 mb-6 leading-relaxed">
                The Staff Selection Commission Combined Graduate Level (SSC CGL) is one of the most prestigious exams in India for recruiting personnel in various Group B and Group C posts across ministries and departments.
              </p>
