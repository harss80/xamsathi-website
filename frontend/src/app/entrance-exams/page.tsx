    ...
    <div className="min-h-screen bg-slate-950 text-slate-200">
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="flex items-center gap-3 mb-6">
          <div className="p-3 rounded-2xl bg-slate-500/10 border border-slate-500/20 text-slate-200">
            <Sparkles className="w-6 h-6" />
          </div>
          <h1 className="text-3xl md:text-5xl font-black text-white">Private / Entrance Exams</h1>
        </div>

        <p className="text-slate-400 max-w-3xl">
          CUET and other entrance exam practice sets.
        </p>

        <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-6">
          <Link href="/entrance-exams/cuet" className="p-6 rounded-3xl bg-slate-900 border border-slate-800 hover:border-slate-400/50 transition-all">
            <div className="text-xl font-black text-white">CUET</div>
            <div className="text-sm text-slate-400 mt-2">Practice sets</div>
          </Link>
        </div>
