...
export default function ENTRANCEEXAMSCategory() {
  const exams = [
    {
        id: 'cuet',
        title: 'CUET',
        desc: 'Domain specific mocks',
        tests: 200,
        users: '3 Lakh',
        tag: 'Trending',
        link: '/entrance-exams/cuet'
    }
];
      ...
      <div className="pt-28 pb-16 bg-gradient-to-b from-slate-900 to-slate-950 border-b border-slate-800">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-black text-white mb-6">Master <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-emerald-400">Private/Entrance Exams</span></h1>
            <p className="text-lg text-slate-400 mb-8 leading-relaxed">
              Test series for CUET, State entrances and private university exams.
            </p>
            ...
            <div className="flex flex-wrap items-center justify-center gap-2 mt-6">
              {['All','CUET','State','Private'].map((filter) => (
