...
import {
    ...
    BookOpen, CheckCircle2, HelpCircle, XCircle
} from "lucide-react";
        ...
        <div className="min-h-screen bg-slate-950 text-slate-100 font-sans selection:bg-pink-500/30">
            ...
            {status === "result" && (
                <div className="max-w-4xl mx-auto px-6 py-12">
                    ...
                    <h2 className="text-2xl font-bold text-white mb-8 flex items-center gap-2 mt-12">
                        ...
                        {QUESTIONS.map((q, qIdx) => {
                            ...
                            return (
                                <div key={q.id} className="bg-slate-900/50 border border-slate-800 rounded-3xl p-6 md:p-8 hover:bg-slate-800/30 transition-colors">
                                    <div className="flex items-start justify-between gap-4 mb-6">
                                        <div className="flex-1">
                                            <div className="flex items-center gap-3 mb-2">
                                                <span className={`px-2 py-1 rounded text-xs font-bold uppercase tracking-wider border ${q.type === 'genetics' ? 'bg-purple-400/10 text-purple-400 border-purple-500/20' : 'bg-green-400/10 text-green-400 border-green-500/20'}`}>
                                                    {q.type}
                                                </span>
                                    ...
                                    <div className="bg-pink-950/20 border border-pink-900/30 p-6 rounded-2xl relative overflow-hidden">
                                        ...
                                        <div className="flex gap-4">
                                            ...
                                            <div>
                                                <h5 className="text-pink-400 font-bold text-sm uppercase tracking-wider mb-2">Teacher's Explanation</h5>
