          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center max-w-7xl mx-auto">
            ...
            <div className="lg:col-span-7 text-center lg:text-left">
              ...
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-6 mb-8 text-slate-300">
                ...
                <div className="flex items-center gap-2"><BookOpen className="w-5 h-5 text-emerald-400" /><span className="font-bold text-lg">${data.prelims} Prelims / ${data.mains} Mains</span></div>
                <div className="w-1.5 h-1.5 rounded-full bg-slate-700"></div>
              ...
              <div className="bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800 rounded-3xl p-8 shadow-2xl relative z-10 text-center flex flex-col items-center">
                ...
                <div className="w-full space-y-3 mb-8 text-left">
                  <div className="flex items-start gap-3 text-slate-300 font-medium">
                    <CheckCircle2 className="w-5 h-5 text-blue-400 shrink-0" /> Full Access to ${data.totalTests}+ Tests
                  </div>
                  <div className="flex items-start gap-3 text-slate-300 font-medium">
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-slate-950 border border-slate-800 p-8 rounded-3xl hover:border-slate-700 transition-colors">
              ...
              <div className="text-4xl font-black text-blue-400 mb-2">${data.prelims}</div>
            ...
            <div className="bg-slate-950 border border-slate-800 p-8 rounded-3xl hover:border-slate-700 transition-colors">
              ...
              <div className="text-4xl font-black text-indigo-400 mb-2">${data.mains}</div>
             ...
             <div className="bg-slate-950 rounded-3xl border border-slate-800 overflow-hidden shadow-2xl">
                <table className="w-full text-center">
                  ...
                  <tbody className="text-slate-300">
                    <tr className="border-b border-slate-800/50"><td className="p-6 font-bold">Prelims Mock</td><td className="p-6 font-black text-white">${data.prelims}</td><td className="p-6 font-bold text-slate-500">60 min</td></tr>
                    <tr className="border-b border-slate-800/50"><td className="p-6 font-bold">Mains Mock</td><td className="p-6 font-black text-white">${data.mains}</td><td className="p-6 font-bold text-slate-500">120 - 180 min</td></tr>
                    <tr className="border-b border-slate-800/50"><td className="p-6 font-bold">Sectional Tests</td><td className="p-6 font-black text-white">${data.sectional}</td><td className="p-6 font-bold text-slate-500">20 min</td></tr>
                    <tr className="border-b border-slate-800/50"><td className="p-6 font-bold">PYQ</td><td className="p-6 font-black text-white">${data.pyq}</td><td className="p-6 font-bold text-slate-500">Varies</td></tr>
                  </tbody>
                </table>
             </div>
         </div>
      ...
      <section id="demo" className="py-24 bg-slate-950 border-b border-slate-800 text-center relative">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto bg-slate-900 border border-slate-800 rounded-3xl p-12 shadow-2xl">
             ...
             <p className="text-slate-400 mb-8 max-w-md mx-auto">1 Free Full-Length ${data.name} Mock. Experience the precise exam interface.</p>
